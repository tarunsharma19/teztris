    ...
    def test():
        ...
        FA12(
            ...
            token_metadata = {
                ...
                "name"        : "TokenB-ctez PNLP", # Recommended
                "symbol"      : "TokenB-ctez-LP",            # Recommended
                # Extra fields
                "icon"        : 'https://raw.githubusercontent.com/Parizval/TezSureFarm/main/assets/coin.png'
            },
            contract_metadata = {
                "" : "ipfs://bafkreidruexxcfptojsch4tr7bjfuixw3jkgimzblgoshwlrsy4luc2oyq",
            }
        )
    )